...
st.set_page_config(
   ...
   page_icon='C:\\Users\\LENOVO\\Downloads\\Smart_Resume_Analyser_App-master\\Smart_Resume_Analyser_App-master\\Logo\\SRA_Logo.ico',
)
def run():
    ...
    link = '[©Developed by Ritik](https://www.linkedin.com/in/ritik-dubey-3b863b1b8)'
    st.sidebar.markdown(link, unsafe_allow_html=True)
    #st.sidebar.image(r"C:\\Users\\LENOVO\\Downloads\\Smart_Resume_Analyser_App-master\\Smart_Resume_Analyser_App-master\\Logo\\1.png",use_column_width=True)
   
    img = Image.open('C:\\Users\\LENOVO\\Downloads\\Smart_Resume_Analyser_App-master\\Smart_Resume_Analyser_App-master\\Logo\\resume_parsing_22_feb.jpg')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            with st.spinner('Uploading your Resume....'):
                time.sleep(3)
            save_image_path = 'C:\\Users\\LENOVO\\Downloads\\Smart_Resume_Analyser_App-master\\Smart_Resume_Analyser_App-master\\Uploaded_Resumes'+pdf_file.name
        ...
        if st.button('Login'):
            if ad_user == 'Raushan' and ad_password == 'Panjiyar':
                st.success("Welcome Raushan Panjiyar")
                # Display Data
            ...
            elif ad_user == 'Ritik' and ad_password == 'Dubey':
                st.success("Welcome Ritik Dubey")
                # Display Data
                cursor.execute('''SELECT*FROM user_data''')
                data = cursor.fetchall()
                st.header("**User's👨‍💻 Data**")
            ...
            elif ad_user == 'Rohan' and ad_password == 'Mistry':
                st.success("Welcome Rohan Mistry")
                # Display Data
                cursor.execute('''SELECT*FROM user_data''')
                data = cursor.fetchall()
                st.header("**User's👨‍💻 Data**")
